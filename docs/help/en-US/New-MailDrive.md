...
online version: https://github.com/yotsuda/MailDrive/blob/master/docs/help/en-US/New-MailDrive.md
schema: 2.0.0
---
...
```
New-MailDrive [[-Name] <String>] [-Host] <String> [-Port <Int32>] [-Ssl <String>] -Username <String>
...
### MailDrive.Provider.ImapDriveInfo
